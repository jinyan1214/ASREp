% demo2 of MasonMesh tool (Add openings to facade)
...
addNodes = [1.8, 4, 6.2, 9.8, 12, 14.2, 17.8, 20, 22.2, 25.8, 28, 30.2,...
    33.8, 36, 38.2, 41.8, 44, 46.2];
...
%% Remove opening elements from ele2n
windowElemNo = [];
